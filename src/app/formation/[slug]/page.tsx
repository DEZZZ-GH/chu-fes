...
//   },
// };
// type Params = { slug: keyof typeof formations };

// export default function FormationDetailPage({ params }: { params: { slug: keyof typeof formations } }) {
...
//   return Object.keys(formations).map((slug) => ({ slug })) as Params[];
// }
